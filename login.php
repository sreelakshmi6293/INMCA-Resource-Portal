...
<div class="card">
    ...
    <?php if (!empty($success_message)): ?>
        <div class="alert-success" id="alertSuccess"><?php echo htmlspecialchars($success_message); ?></div>
    <?php endif; ?>
...
// Clear error and success messages when user types in either input
const inputs = document.querySelectorAll('#user_login_identity, #user_login_secret');
